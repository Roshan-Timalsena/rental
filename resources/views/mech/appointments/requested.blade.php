...
<head>
    <meta charset="utf-8" />
    <title>Mechanic | Bike Rental and Servicing</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Requested</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-4">Manage Appointments</h4>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('mech.confirm',['appointment'=>$ap->id])}}"><i class="mdi mdi-check-all me-2 text-muted font-18 vertical-middle"></i>Confirm</a>
                                                            <a class="dropdown-item" href="{{route('mech.cancel',['appointment'=>$ap->id])}}"><i class="mdi mdi-delete me-2 text-muted font-18 vertical-middle"></i>Cancel</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
