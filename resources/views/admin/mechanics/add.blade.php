                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add new Mechanic</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <form id="bikes" method="POST" action="{{route('admin.storeMech')}}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="mechname" type="text" id="mechname"
                                                            class="form-control" value="{{old('mechname')}}">
                                                    </div>
                                                    ...
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Add New Mechanic</button>
                                                </form>
                                            </div>
                                        </div>
