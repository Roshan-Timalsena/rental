                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Mechanics</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Update Mechanic</h4>
                                        <p class="sub-header font-13">
                                            Please Fill out the form below. Only Update the Reuired Fields
                                        </p>

                                        <div class="row">
                                            <div class="col-lg-6">
                                                <form id="bikes" method="POST" action="{{route('admin.updateMech',['mechanic'=>$mechanic->id])}}"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="mechname" class="form-label">name</label>
                                                        <input name="mechname" type="text" id="mechname"
                                                            class="form-control" value="{{$mechanic->user->name}}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="desc" class="form-label">description</label>
                                                        <input name="desc" type="text" id="desc"
                                                            class="form-control" value="{{$mechanic->description}}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="price" class="form-label">price</label>
                                                        <input name="price" type="text" id="price"
                                                            class="form-control" value="{{$mechanic->price}}">
                                                    </div>
                                                    
                                                    <div class="mb-3">
                                                        <label for="experience" class="form-label">experience</label>
                                                        <input name="experience" type="text" id="experience"
                                                            class="form-control" value="{{$mechanic->experience}}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="phone" class="form-label">phone</label>
                                                        <input name="phone" type="text" id="phone"
                                                            class="form-control" value="{{$mechanic->user->phone}}">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="pics" class="form-label">Bike Pics</label>
                                                        <input name="pics[]" type="file" multiple id="pics"
                                                            class="form-control">
                                                    </div>

                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Update Mechanic</button>
                                                </form>
                                            </div>
                                        </div>
