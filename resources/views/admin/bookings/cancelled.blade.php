                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-4">Confirmed Bookings</h4>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('bikes.undoCancel',['booking'=>$booking->id])}}"><i class="mdi mdi-undo-variant me-2 text-muted font-18 vertical-middle"></i>Undo</a>
                                                        </div>
                                                    </div>
                                                </td>
