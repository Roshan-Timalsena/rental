                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$requested}}</span></h3>
                                                <p class="text-muted mb-1 text-truncate">Requested</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$confirmed}}</span></h3>
                                                <p class="text-muted mb-1 text-truncate">Confirmed</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$cancelled}}</span></h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-4">Manage Bookings</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$booking->total}}</td>
                                                @if($booking->rent_status == 'requested')
                                                <td><span class="badge bg-soft-warning text-warning">{{$booking->rent_status}}</span></td>
                                                @endif
                                                @if($booking->rent_status == 'confirmed')
                                                <td><span class="badge bg-success">{{$booking->rent_status}}</span></td>
                                                @endif
                                                @if($booking->rent_status == 'cancelled')
                                                <td><span class="badge bg-soft-danger text-danger">{{$booking->rent_status}}</span></td>
                                                @endif 
                                                @if($booking->rent_status == 'pending')
                                                <td><span class="badge bg-secondary text-light">{{$booking->rent_status}}</span></td>
                                                @endif 
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('booking.delete',['booking'=>$booking->id])}}"><i class="mdi mdi-delete me-2 text-muted font-18 vertical-middle"></i>Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
