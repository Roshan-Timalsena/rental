                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('admin.confirm',['booking'=>$booking->id])}}"><i class="mdi mdi-check-all me-2 text-muted font-18 vertical-middle"></i>Confirm</a>
                                                            <a class="dropdown-item" href="{{route('admin.cancel',['booking'=>$booking->id])}}"><i class="mdi mdi-delete me-2 text-muted font-18 vertical-middle"></i>Cancel</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
