                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Add Bikes</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add new Bike</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <form id="bikes" method="POST" action="{{ route('admin.storebike') }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="bikename" type="text" id="bikename"
                                                            class="form-control" value="{{old('bikename')}}">
                                                    </div>
                                                    ...
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Add New Bike</button>
                                                </form>
                                            </div>
                                        </div>
