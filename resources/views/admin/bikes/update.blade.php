                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Update Bikes</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Update Bike</h4>
                                        <p class="sub-header font-13">
                                            Please Fill out the form below. Update Only the necessary fields.
                                        </p>

                                        <div class="row">
                                            <div class="col-lg-6">
                                                <form id="bikes" method="POST" action="{{route('admin.updateBike',['bike'=>$bike->id])}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="bikename" class="form-label">name</label>
                                                        <input name="bikename" type="text" id="bikename"
                                                            class="form-control" value="{{$bike->name}}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="desc" class="form-label">description</label>
                                                        <input name="desc" type="text" id="desc"
                                                            class="form-control" value="{{$bike->description}}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="price" class="form-label">price</label>
                                                        <input name="price" type="text" id="price"
                                                            class="form-control" value="{{$bike->priceperday}}">
                                                    </div>
                                                    ...
                                                    <select name="brand" class="form-select">
                                                        ...
                                                        @foreach ($brands as $brand)
                                                            <option value="{{$brand->id}}" {{$bike->brand_id == $brand->id ? 'selected' : ''}}>{{$brand->name}}</option>
                                                        @endforeach
                                                    ...
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Update Bike</button>
                                                </form>
                                            </div>
                                        </div>
