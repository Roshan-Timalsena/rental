...
<html lang="en">
    ...
    <head>
		...
		<link href="/layout/assets/css/config/purple/bootstrap.min.css" rel="stylesheet" type="text/css" id="bs-default-stylesheet" />
		<link href="/layout/assets/css/config/purple/app.min.css" rel="stylesheet" type="text/css" id="app-default-stylesheet" />

		<link href="/layout/assets/css/config/purple/bootstrap-dark.min.css" rel="stylesheet" type="text/css" id="bs-dark-stylesheet" />
		<link href="/layout/assets/css/config/purple/app-dark.min.css" rel="stylesheet" type="text/css" id="app-dark-stylesheet" />
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">It's looking like you may have taken a wrong turn.</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Return to <a href="/" class="text-white ms-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
