				...
				<div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
					...
					<nav class="hs_main_menu d-none d-sm-none d-xs-none d-md-block">
						<ul>
							...
							<li>
								<div class="dropdown-wrapper menu-button"> <a class="menu-button" href="#">Bikes</a>
								</div>
							</li>
							<li> <a class="menu-button single_menu" href="about.html">Mechanics</a>
							</li>
							<li> <a class="menu-button single_menu" href="team.html">About </a>
							</li>
						</ul>
					</nav>
								...
								<div class="col-xs-6 col-sm-6 col-6">
									...
									<nav class="cd-dropdown">
										...
										<ul class="cd-dropdown-content">
											...
											<li> <a href="about.html">Mechanics</a>
											</li>
